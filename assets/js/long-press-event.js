...
(function (window, document) {
    ...
    //Naseem Edit: we want no mouse long pres, so only touch.
    var mouseDown = isTouch ? 'touchstart' : 'touchstart';
    var mouseUp = isTouch ? 'touchend' : 'touchend';
    var mouseMove = isTouch ? 'touchmove' : 'touchmove';
